...
test("CellId#constructor accepts id: string", () => {
...
test("CellId#constructor accepts ll: LatLng", () => {
  ...
  expect(cellId.id()).toBe('6924438073539270971');
...
test("CellId#FromToken works", () => {
  ...
  expect(cellId.id()).toBe('9926594110334959616');
...
test("CellId#child works", () => {
  ...
  expect(leaf.id()).toBe('6924438073539270971');
